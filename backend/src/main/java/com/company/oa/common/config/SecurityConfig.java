...
import com.company.oa.common.filter.RateLimitFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource(
            @Value("${cors.allowed-origins:http://localhost:5173,http://localhost:3000,http://localhost:8090,http://111.229.144.40:8090}") List<String> allowedOrigins) {
