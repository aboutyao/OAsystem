...
const businessTypeOptions = [
  { label: '全部权限相关', value: '' },
  { label: 'PERM_ADD', value: 'PERM_ADD' },
  { label: 'PERM_EDIT', value: 'PERM_EDIT' },
  { label: 'PERM_DELETE', value: 'PERM_DELETE' },
  { label: 'ROLE_ADD', value: 'ROLE_ADD' },
  { label: 'ROLE_EDIT', value: 'ROLE_EDIT' },
  { label: 'ROLE_DELETE', value: 'ROLE_DELETE' },
  { label: 'MENU_ADD', value: 'MENU_ADD' },
  { label: 'MENU_EDIT', value: 'MENU_EDIT' },
  { label: 'MENU_DELETE', value: 'MENU_DELETE' },
  { label: 'BUTTON_ADD', value: 'BUTTON_ADD' },
  { label: 'BUTTON_EDIT', value: 'BUTTON_EDIT' },
  { label: 'BUTTON_DELETE', value: 'BUTTON_DELETE' },
]
...
<template>
  <div class="oa-page">
    <div class="oa-page__head">
      <div>
        <h2 class="oa-page__title">权限变更日志</h2>
        <p class="muted">记录权限、角色、菜单、按钮相关的所有变更操作。</p>
      </div>
    </div>
