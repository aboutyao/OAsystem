...
const businessTypeOptions = [
  { label: '全部规则相关', value: '' },
  { label: 'RULE_ADD', value: 'RULE_ADD' },
  { label: 'RULE_EDIT', value: 'RULE_EDIT' },
  { label: 'RULE_DELETE', value: 'RULE_DELETE' },
  { label: 'RULE_PUBLISH', value: 'RULE_PUBLISH' },
  { label: 'RULE_DISABLE', value: 'RULE_DISABLE' },
]
...
<template>
  <div class="oa-page">
    <div class="oa-page__head">
      <div>
        <h2 class="oa-page__title">规则变更日志</h2>
        <p class="muted">记录规则的新增、编辑、删除、发布、停用等操作。</p>
      </div>
    </div>
